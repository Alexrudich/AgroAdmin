        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPricePerNightPondHalf = table.Column<int>(type: "int", nullable: false),
                    PricePerAdultPondHalf = table.Column<int>(type: "int", nullable: false),
                    IncludedAdultsPondHalf = table.Column<int>(type: "int", nullable: false),
                    MinPricePerNightParkingHalf = table.Column<int>(type: "int", nullable: false),
                    PricePerAdultParkingHalf = table.Column<int>(type: "int", nullable: false),
                    IncludedAdultsParkingHalf = table.Column<int>(type: "int", nullable: false),
